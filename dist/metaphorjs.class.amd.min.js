...
a[1],a[2]);case 4:return new this(a[0],a[1],a[2],a[3]);default:return l(this,a)}};b.$override=function(a){var b=this.$self,c=this.$parent;b&&c&&m(b.prototype,a,c)};b.$extend=function(a,b){return h(a,b,this)};var h=function(e,s,c){e=e||{};var h=e.$class,g=c||e.$extends,f=e.$mixins,l,n,p;g?t(g)?c=a.get(g):(c=g,g=c.$class||""):(c=b,g="");if(g&&!c)throw Error(g+" not found");h&&(h=a.normalize(h));e.$class=h;e.$extends=g;e.$mixins=null;l=function(){};l.prototype=c.prototype;g=new l;l=null;e.$constructor=
e.$constructor||k;m(g,e,c);if(f)for(e=0,l=f.length;e<l;e++)p=f[e],t(p)&&(p=a.get("mixin."+p,!0)),q(g,p);f=d();g.constructor=f;f.prototype=g;for(n in b)"prototype"!=n&&b.hasOwnProperty(n)&&(f[n]=b[n]);for(n in c)"prototype"!=n&&c.hasOwnProperty(n)&&(f[n]=c[n]);if(s)for(n in s)"prototype"!=n&&s.hasOwnProperty(n)&&(f[n]=s[n]);f.$parent=c;f.$self=f;h&&a.register(h,f);return f},l=function(b){var d=a.get(b),c=x.call(arguments,1);if(!d)throw Error(b+" not found");return d.$instantiate.apply(d,c)};this.factory=
l;this.isSubclassOf=function(b,d){var c=b,h=a.get;d=t(d)?a.normalize(d):d.prototype.$class;for(t(b)&&(c=h(a.normalize(b)));c&&c.prototype;){if(c.prototype.$class==d)return!0;c=c.$parent}return!1};this.isInstanceOf=function(b,d){var c=t(d)?a.get(d):d;return c?b instanceof c:!1};this.define=h;this.BaseClass=b};h.prototype={factory:null,isSubclassOf:null,isInstanceOf:null,define:null};return h}()});
