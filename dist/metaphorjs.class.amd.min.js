...
remove:function(a){var d=b[a];d&&!0===d.rewritable&&delete b[a];return d?d.value:void 0},exists:function(a){return!!b[a]},eachEntry:function(a,d){for(var c in b)a.call(d,b[c].value,c)},clear:function(){b={}},$destroy:function(){this===a&&(a=null);this.remove=this.exists=this.destroy=this.get=this.add=c=b=null}}};g.global=function(){a||(a=new g(!0));return a};return g}(),B=x.lib.Namespace=function(a){a=a||{};var g=new J(!1),c=function(b,d){var c=g.get(b,!0);if(void 0!==c||d)return c;d=b.split(".");
