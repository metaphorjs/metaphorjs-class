define("metaphorjs-class",function(){function C(a){if(null===a||"object"!=typeof a)return!1;a=y(a);return 2<a||-1==a}function v(a){return"string"===typeof a||a===""+a}function D(a){if(a&&void 0!=!a.length&&a!==""+a){for(var g=[],c=-1,b=a.length>>>0;++c!==b;g[c]=a[c]);return g}return a?[a]:[]}function z(a){return"object"==typeof a&&3===y(a)&&!a.nodeType&&a.constructor===Object}function E(a){return!0===a||!1===a}function A(){var a=!1,g=!1,c=D(arguments),b=c.shift(),d,m,f;E(c[c.length-1])&&(a=c.pop());
...
g.apply(c||b,arguments);var h=!1!==f?a.apply(b||c,arguments):null}else h=a.apply(b||c,arguments),f=g.apply(c||b,arguments);return m?f:h}}var x={plugin:{},mixin:{},lib:{}},I=x.lib.Cache=function(){var a,g=function(c){var b={},d=[];0==arguments.length&&(c=!0);return{addFinder:function(a,b,h){d[h?"unshift":"push"]({fn:a,context:b})},add:function(d,a,h){if(b[d]&&!1===b[d].rewritable)return b[d];b[d]={rewritable:"undefined"!=typeof h?h:c,value:a};return a},get:function(a,f){if(!b[a]){if(d.length){var m;
var c=0;for(m=d.length;c<m;c++){var k=d[c].fn.call(d[c].context,a,this);if(void 0!==k)return this.add(a,k,!0)}}return void 0!==f?this.add(a,f):void 0}return b[a].value},remove:function(a){var d=b[a];d&&!0===d.rewritable&&delete b[a];return d?d.value:void 0},exists:function(a){return!!b[a]},eachEntry:function(a,d){for(var c in b)a.call(d,b[c].value,c)},clear:function(){b={}},$destroy:function(){this===a&&(a=null);this.remove=this.exists=this.destroy=this.get=this.add=c=b=null}}};g.global=function(){a||
(a=new g(!0));return a};return g}(),J=Object.prototype.toString,y=function(){var a={"[object String]":0,"[object Number]":1,"[object Boolean]":2,"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(g){if(!g){if(null===g)return 6;if(void 0===g)return 7}var c=a[J.call(g)];return void 0===c?-1:1===c&&isNaN(g)?8:c}}(),B=x.lib.Namespace=function(a){a=a||{};var g=new I(!1),c=function(b,d){var c=g.get(b);if(void 0!==c||d)return c;d=b.split(".");
var f=d.length,h=a;for(c=0;c<f;c++){var r=d[c];if(void 0===h[r])return;h=h[r]}h&&g.add(b,h);return h};this.register=function(b,d){var c=b.split("."),f=c.pop();var h=c.join(".");var r=c.length,k=a;if(g[h])b=[g[h],f,b];else{if(0<r)for(h=0;h<r;h++){var n=c[h];void 0===k[n]&&(k[n]={});k=k[n]}b=[k,f,b]}c=b[0];f=b[1];C(c)&&void 0===c[f]&&(c[f]=d,g.add(b[2],d));return d};this.exists=function(a){return void 0!==c(F,!0)};this.get=c;this.add=function(a,d){return g.add(a,d)};this.remove=function(a){return g.remove(a)};
