(function(){function v(a){return"string"===typeof a||a===""+a}function E(a){if(null===a||"object"!=typeof a)return!1;a=y(a);return 2<a||-1==a}function F(a){if(a&&void 0!=!a.length&&a!==""+a){for(var g=[],c=-1,b=a.length>>>0;++c!==b;g[c]=a[c]);return g}return a?[a]:[]}function z(a){return"object"==typeof a&&3===y(a)&&!a.nodeType&&a.constructor===Object}function G(a){return!0===a||!1===a}function A(){var a=!1,g=!1,c=F(arguments),b=c.shift(),d,m,f;G(c[c.length-1])&&(a=c.pop());G(c[c.length-1])&&(g=a,
a=c.pop());for(;d=c.shift();)for(m in d)if(d.hasOwnProperty(m)&&void 0!==(f=d[m]))if(g)if(b[m]&&z(b[m])&&z(f))A(b[m],f,a,g);else{if(!0===a||void 0==b[m])z(f)?(b[m]={},A(b[m],f,a,!0)):b[m]=f}else if(!0===a||void 0==b[m])b[m]=f;return b}function u(){}function I(a,g){var c=function(){};c.prototype=a.prototype;c=new c;a=a.apply(c,g);return E(a)||!1===a?a:c}function J(a,g,c,b,d,m){d=d||"before";return function(){if("instead"==d)return g.apply(c||b,arguments);if("before"==d){var f=g.apply(c||b,arguments);
var h=!1!==f?a.apply(b||c,arguments):null}else h=a.apply(b||c,arguments),f=g.apply(c||b,arguments);return m?f:h}}var K=Object.prototype.toString,y=function(){var a={"[object String]":0,"[object Number]":1,"[object Boolean]":2,"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(g){if(!g){if(null===g)return 6;if(void 0===g)return 7}var c=a[K.call(g)];return void 0===c?-1:1===c&&isNaN(g)?8:c}}(),x={plugin:{},mixin:{},lib:{}},L=x.lib.Cache=
function(){var a,g=function(c){var b={},d=[];0==arguments.length&&(c=!0);return{addFinder:function(a,b,h){d[h?"unshift":"push"]({fn:a,context:b})},add:function(d,a,h){if(b[d]&&!1===b[d].rewritable)return b[d];b[d]={rewritable:"undefined"!=typeof h?h:c,value:a};return a},get:function(a,f){if(!b[a]){if(d.length){var m;var c=0;for(m=d.length;c<m;c++){var k=d[c].fn.call(d[c].context,a,this);if(void 0!==k)return this.add(a,k,!0)}}return void 0!==f?this.add(a,f):void 0}return b[a].value},remove:function(a){var d=
b[a];d&&!0===d.rewritable&&delete b[a];return d?d.value:void 0},exists:function(a){return!!b[a]},eachEntry:function(a,d){for(var c in b)a.call(d,b[c].value,c)},clear:function(){b={}},$destroy:function(){this===a&&(a=null);this.remove=this.exists=this.destroy=this.get=this.add=c=b=null}}};g.global=function(){a||(a=new g(!0));return a};return g}(),B=x.lib.Namespace=function(a){a=a||{};var g=new L(!1),c=function(b,d){var c=g.get(b);if(void 0!==c||d)return c;d=b.split(".");var f=d.length,h=a;for(c=0;c<
f;c++){var r=d[c];if(void 0===h[r])return;h=h[r]}h&&g.add(b,h);return h};this.register=function(b,d){var c=b.split("."),f=c.pop();var h=c.join(".");var r=c.length,k=a;if(g[h])b=[g[h],f,b];else{if(0<r)for(h=0;h<r;h++){var n=c[h];void 0===k[n]&&(k[n]={});k=k[n]}b=[k,f,b]}c=b[0];f=b[1];E(c)&&void 0===c[f]&&(c[f]=d,g.add(b[2],d));return d};this.exists=function(a){return void 0!==c(H,!0)};this.get=c;this.add=function(a,d){return g.add(a,d)};this.remove=function(a){return g.remove(a)};this.makeAlias=function(a,
d){a=g.get(a);void 0!==a&&g.add(d,a);return a};this.$destroy=function(){var a;g.eachEntry(function(a){a&&a.$destroy&&a.$destroy()});g.$destroy();g=null;for(a in this)this[a]=null}},C=function(){var a=function(){this.$super&&this.$super!==u&&this.$super.apply(this,arguments)},g=function(a,c,b){var $super=a.prototype[c]||("$constructor"===c?a:u)||u;return function(){var a=this.$super;if(this.$destroyed)return this.$super=null;this.$super=$super;var k=b.apply(this,arguments);this.$super=a;return k}},
c=function(a,c,b,h){var d,k=b.prototype;for(d in c)if(c.hasOwnProperty(d)){var n=k[d];var f=c[d];a[d]="function"!=typeof f||n&&"function"!=typeof n?f:g(b,d,f)}h||(a.$plugins=null,a.$pluginMap=null,k.$beforeInit?(a.$beforeInit=k.$beforeInit.slice(),a.$afterInit=k.$afterInit.slice(),a.$beforeDestroy=k.$beforeDestroy.slice(),a.$afterDestroy=k.$afterDestroy.slice()):(a.$beforeInit=[],a.$afterInit=[],a.$beforeDestroy=[],a.$afterDestroy=[]))},b=function(d){d||(d=new B);var g=function(a){return function(){var k=
...
b)?a instanceof b:!1};h.classManagerFactory=b;h.factory=function(a){var b=d?d.get(a):null,c=F(arguments).slice(1);if(!b)throw a+" not found";return b.$instantiate.apply(b,c)};h.isSubclassOf=function(a,b){var c=a,f=d?d.get:function(){};v(b)||(b=b.prototype.$class);for(v(a)&&(c=f(a));c&&c.prototype;){if(c.prototype.$class===b)return!0;c=c.$parent}return!1};h.isInstanceOf=r;h.define=h;h.Namespace=B;h.BaseClass=f;h.ns=d;h.$destroy=function(){f.$destroy();f=null;d&&(d.$destroy(),d=null)};return h};return b}(),
H=function(){var a=new B;a.register("MetaphorJs",x);a.register("mjs",x);return a}();C=C(H);var D={};D.cls=C;"undefined"!=typeof global?global.MetaphorJs=D:window.MetaphorJs=D})();
